...
class Result(Model):
    ...
    def __init__(self, id=None, description=None, essence=None, essence_type=None, row_data=None, score=None, score_name=None, score_direction=None, confidence=None, result_type=None, result_group=None, result_group_similarity_score=None, reasoner_id=None, result_graph=None, node_bindings=None, edge_bindings=None):  # noqa: E501
        ...
        :type node_bindings: Dict[str, OneOfstringarray]
        :param edge_bindings: The edge_bindings of this Result.  # noqa: E501
        :type edge_bindings: Dict[str, OneOfstringarray]
        """
        self.openapi_types = {
            'id': str,
            'description': str,
            ...
            'node_bindings': Dict[str, OneOfstringarray],
            'edge_bindings': Dict[str, OneOfstringarray]
        }
    ...
    def node_bindings(self):
        ...
        :rtype: Dict[str, OneOfstringarray]
        """
