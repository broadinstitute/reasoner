...
MERGE (d)-[:HAS_SYNONYM]->(:Synonym {name: line.disease_str, type: 'umls_concept', resource: 'UMLS'})
MERGE (t)-[:HAS_ID]->(:Identifier {id: line.location_cui, type: 'cui', resource: 'UMLS'})
MERGE (t)-[:HAS_SYNONYM]->(:Synonym {name: line.location_str, type: 'umls_concept', resource: 'UMLS'});
